...
class PointsServiceTest extends TestCase
{
    ...
    public function provideRollsForFlush(): array
    {
        return [
            [
                (new DiceCupEntity())->setDice1(3)
                    ->setDice2(4)
                    ->setDice3(1)
                    ->setDice4(2)
                    ->setDice5(5)
                    ->setDice6(4),
                (new DiceCupEntity())->setDice1(null)
                    ->setDice2(null)
                    ->setDice3(null)
                    ->setDice4(null)
                    ->setDice5(null)
